...
class Edit(tk.Tk):
    def __init__(self):
        ...
        self.splash_frame = tk.Frame(self, background="grey")
        ...
        self.loading = Image.open('c:\\Users\\User\\OneDrive\\PycharmProjects\\pythonProject\\logo.jpg')
        ...
        self.developer_label = tk.Label(self, text='by GULAIYM IBRAIMOVA', foreground="white",
        ...
        adjust_icon = Image.open('c:\\Users\\User\\OneDrive\\PycharmProjects\\pythonProject\\logo.jpg')
        adjust_icon = adjust_icon.resize((25, 25), Image.ANTIALIAS)
        adjust_icon = ImageTk.PhotoImage(adjust_icon)

        filter_icon = Image.open('c:\\Users\\User\\OneDrive\\PycharmProjects\\pythonProject\\logo.jpg')
        filter_icon = filter_icon.resize((25, 25), Image.ANTIALIAS)
        filter_icon = ImageTk.PhotoImage(filter_icon)

        save_icon = Image.open('c:\\Users\\User\\OneDrive\\PycharmProjects\\pythonProject\\logo.jpg')
        ...
        power_off_icon = Image.open('c:\\Users\\User\\OneDrive\\PycharmProjects\\pythonProject\\logo.jpg')
        power_off_icon = power_off_icon.resize((25, 25), Image.ANTIALIAS)
        power_off_icon = ImageTk.PhotoImage(power_off_icon)

        self.error_icon = Image.open('c:\\Users\\User\\OneDrive\\PycharmProjects\\pythonProject\\logo.jpg')
        self.error_icon = self.error_icon.resize((50, 50), Image.ANTIALIAS)
        self.error_icon = ImageTk.PhotoImage(self.error_icon)

        self.open_image_icon = Image.open('c:\\Users\\User\\OneDrive\\PycharmProjects\\pythonProject\\logo.jpg')
        ...
        self.open_image_small_icon = Image.open('c:\\Users\\User\\OneDrive\\PycharmProjects\\pythonProject\\logo.jpg')
        ...
        self.checked_icon = Image.open('c:\\Users\\User\\OneDrive\\PycharmProjects\\pythonProject\\logo.jpg')
        self.checked_icon = self.checked_icon.resize((25, 25), Image.ANTIALIAS)
        self.checked_icon = ImageTk.PhotoImage(self.checked_icon)

        self.unchecked_icon = Image.open('c:\\Users\\User\\OneDrive\\PycharmProjects\\pythonProject\\logo.jpg')
        ...
        reset_icon = Image.open('c:\\Users\\User\\OneDrive\\PycharmProjects\\pythonProject\\logo.jpg')
        reset_icon = reset_icon.resize((25, 25), Image.ANTIALIAS)
        reset_icon = ImageTk.PhotoImage(reset_icon)

        color_picker_icon = Image.open('c:\\Users\\User\\OneDrive\\PycharmProjects\\pythonProject\\logo.jpg')
        color_picker_icon = color_picker_icon.resize((25, 25), Image.ANTIALIAS)
        color_picker_icon = ImageTk.PhotoImage(color_picker_icon)

        heading = tk.Label(self.image_editor_window, text="Ala-Too International University\Image Editor", background="sky blue", font="lucida 9 bold")
        ...
        self.reset_b = tk.Button(self.image_editor_window, text="Reset", foreground="white", compound="left",
                                 font="lucida 9 bold", image=reset_icon, background="grey",
        ...
        self.draw_save = tk.Button(self.image_editor_window, image=save_icon, compound='left', text="Save",
                                   foreground="white", font="lucida 10 bold", background="grey",
